...
def test_all_available_filing_retrieval_common_stock(downloader, apple_filing_metadata):
    ...
    num_downloaded = dl.get_all_available_filings(apple_filing_metadata["ticker_symbol"], 2)
...
def test_all_available_filing_retrieval_institutional_investor(downloader, vanguard_filing_metadata):
    ...
    num_downloaded = dl.get_all_available_filings(vanguard_filing_metadata["ticker_full_cik"], 2)
